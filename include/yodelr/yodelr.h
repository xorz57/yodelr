...
namespace yodelr {
    ...
    public:
        ...
        virtual void addPost(const std::string &userName, const std::string &postText, uint64_t timestamp) = 0;
        ...
        virtual Topics getTrendingTopics(uint64_t fromTimestamp, uint64_t toTimestamp) const = 0;
    };
}// namespace yodelr
